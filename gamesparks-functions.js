...
GameSparks.prototype.processNewTick = function(TicketID, onResponse )
{
    var request = {};
    	request["eventKey"]= "newTick"
		request["qid"] = TicketID;
    gamesparks.sendWithData("LogEventRequest", request, onResponse);
}

GameSparks.prototype.updateWordScore = function(TicketID, Word, wordScore, onResponse )
{
    var request = {};
    	request["eventKey"]= "updateWordScore"
		request["ticketID"] = TicketID;
		request["word"] = Word;
		request["wordScore"] = wordScore;
    gamesparks.sendWithData("LogEventRequest", request, onResponse);
}
GameSparks.prototype.updateWeight = function(Type, Score, onResponse )
{
    var request = {};
    	request["eventKey"]= "updateWeight"
		request["uType"] = Type;
		request["dScore"] = Score;
    gamesparks.sendWithData("LogEventRequest", request, onResponse);
}
